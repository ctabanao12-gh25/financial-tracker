  ...
  return (
    <div className="space-y-5 max-w-2xl">
      <div>
        ...
        <p className="text-xs text-slate-500 mt-0.5">Manage your profile and app preferences</p>
      </div>

      {/* ── Profile ── */}
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5">
        <h3 className="text-sm font-semibold text-white mb-5">Profile</h3>
        ...
        <div className="flex items-center gap-4 mb-6">
          <div
            ...
            } flex items-center justify-center text-white text-2xl font-bold select-none shadow-lg`}
          >
            {initials}
          </div>
          <div>
            <p className="text-base font-semibold text-white leading-none">{profile.name}</p>
        ...
        <div className="mb-5">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={saveName}
              className={`px-4 py-2.5 rounded-xl text-sm font-semibold transition min-w-[70px] ${
                savedMsg
          ...
          <div className="flex gap-2 flex-wrap">
            {AVATAR_PRESETS.map((preset) => (
              <button
                ...
                title={preset.label}
                className={`w-9 h-9 rounded-xl bg-gradient-to-br ${preset.gradient} transition-all ${
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5">
        ...
        <label className="block text-xs font-medium text-slate-500 mb-3">Accent Color</label>
          ...
          {THEME_PRESETS.map((preset) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-xs transition ${isActive ? "text-slate-200" : "text-slate-600 group-hover:text-slate-400"}`}>
                  {preset.label}
                </span>
              </button>
            );
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5">
        ...
        <div className="flex flex-col gap-3">
          {/* Export */}
          <div className="flex items-center justify-between p-4 bg-slate-800/60 rounded-xl border border-slate-700/30">
            <div>
              <p className="text-sm font-medium text-slate-200">Export Transactions</p>
            ...
            <button
              ...
              className="flex items-center gap-2 bg-slate-700 hover:bg-slate-600 disabled:opacity-40 disabled:cursor-not-allowed text-slate-200 text-xs font-medium px-3.5 py-2 rounded-xl transition"
            >
          ...
          {/* Clear */}
          <div className="flex items-center justify-between p-4 bg-slate-800/60 rounded-xl border border-rose-500/10">
            <div>
            ...
            <button
              ...
              className="flex items-center gap-2 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 text-xs font-medium px-3.5 py-2 rounded-xl border border-rose-500/20 transition"
            >
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round"
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5">
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <p className="text-sm font-bold text-white">Finto Flash</p>
            <p className="text-xs text-slate-500">Personal Finance Tracker · v1.0.0</p>
          </div>
        </div>
